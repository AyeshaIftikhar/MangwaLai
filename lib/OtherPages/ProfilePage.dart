...
import '../LoginPages/addressFrame2.dart';
    ...
    FirebaseFirestore.instance
      ...
      if (snapshot.exists) {
        setState(() {
          ...
          userData.phNo = snapshot.data()['phoneNo'];
          userData.add1 = snapshot.data()['AddressLine1'];
          userData.add2 = snapshot.data()['AddressLine2'];
          userData.pin = snapshot.data()['ZipCode'];
        });
        print(userData.name);
        print(userData.phNo);
        print(userData.add1);
